...
urlpatterns = [
    ...
    path('simulations/<int:sim_id>/run/<int:run_id>/1hz/',          views.view_run_1hz,             name='dashboard-run-1hz'),
    path('simulations/<int:sim_id>/run/<int:run_id>/1hz/data/',     views.view_run_1hz_data,        name='dashboard-run-1hz-data'),
