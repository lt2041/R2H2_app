...
class Battery:
    ...
    def _load_defaults(config_path: Optional[Path] = None) -> dict:
        ...
        if config_path is None:
            config_path = Path(__file__).parent / 'defaults' / 'battery.yaml'
    ...
    def from_yaml(cls, yaml_path: str):
        """Create Battery instance from a custom YAML configuration file.
        
        Args:
            yaml_path: Path to custom YAML configuration file
        """
